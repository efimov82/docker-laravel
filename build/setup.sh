...
# set timezone machine to Europe/Minsk
...
# set PHP7 timezone to Europe/Minsk
sed -i "s/;date.timezone =*/date.timezone = Europe\/Minsk/" /etc/php/7.0/fpm/php.ini
sed -i "s/;date.timezone =*/date.timezone = Europe\/Minsk/" /etc/php/7.0/cli/php.ini
